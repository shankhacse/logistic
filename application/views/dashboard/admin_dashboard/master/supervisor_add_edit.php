...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Supervisor <?php echo $bodycontent['mode'];?></li>
    </ol>
</section>
                ...
                <p id="clsmsg" class="form_error"></p>                                
                    <form method="post" id="SupervisorForm">
                        ...
                        <div id="supervisor_div" class="form-group">
                            ...
                            <input type="text" class="form-control desablecls" name="spname" id="spname" <?php if ($bodycontent['mode']=="EDIT"){ echo "value='".$bodycontent['editSupervisor']->name."'"; }?>  placeholder="Enter Supervisor Name" autocomplete="off">
                        </div>
